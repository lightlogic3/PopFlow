<!-- RelatedRoles.vue - Related roles list component -->
...
/**
 * Reset to display world's related roles
 */
	...
	<el-card class="section-card">
			...
			<div class="section-header">
				<div class="section-title-container">
					...
					<el-tag v-if="isShowingKnowledgeRoles" type="info" closable @close="resetToWorldRoles">
						{{ selectedKnowledge?.title || "Current Knowledge Point" }}
					</el-tag>
				</div>
		...
		<div class="related-roles" v-loading="rolesLoading">
			<el-empty
				...
				:description="isShowingKnowledgeRoles ? 'No related roles for current knowledge point' : 'No related roles for current world'"
			/>
			<el-tabs v-model="activeName" class="demo-tabs" style="width: 100%">
				...
				<el-tab-pane label="Related Knowledge Points" name="second">
						...
						<el-col :xs="24" :sm="12" :md="8" v-for="knowledge in relateKnowList" :key="knowledge.id">
							...
							>
								<div class="knowledge-header">
									...
									<el-tag :type="knowledge.type === '场景' ? 'success' : 'warning'">
										{{ knowledge.type === '场景' ? 'Scene' : 'Basic' }}
									</el-tag>
								</div>
