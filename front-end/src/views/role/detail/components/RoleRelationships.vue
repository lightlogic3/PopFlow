 ...
 * @property {Array} relationshipLevels - Relationship level list
...
const deleteRelationshipLevelItem = (relationshipLevel) => {
	ElMessageBox.confirm("Are you sure you want to delete this relationship level?", "Confirmation", {
...
<template>
	<div class="relationship-section">
		<div class="section-toolbar">
			<el-button type="primary" size="small" @click="addNewRelationshipLevel">
				<el-icon>
					<Plus />
				</el-icon>
				Add Relationship
				...
				<el-card v-for="item in relationshipLevels" :key="item.id" class="relationship-level-card" shadow="hover">
					...
					<div class="relationship-level-card-footer">
						<div class="relationship-level-update-time">
							...
							<span>Update time: {{ new Date(item.updated_time).toLocaleString() }}</span>
						</div>
						<div class="relationship-level-actions">
							<el-button type="primary" link @click="editRelationshipLevel(item)">
								<el-icon>
									<Edit />
								</el-icon>
								Edit
