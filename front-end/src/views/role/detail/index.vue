...
const fetchRoleDetail = async () => {
	...
	try {
		...
		console.log("Using mock role detail data");
	} catch (error) {
...
/**
 * Get knowledge base fragment list
 */
const fetchKnowledge = async () => {
	...
	try {
		...
		console.error("Failed to get knowledge base fragments", error);
		// Use default value
	} finally {
...
/**
 * Monitor tab changes, cache to localStorage
 */
	...
	<div class="role-detail-container">
		...
		<el-card class="tabs-container">
			<el-tabs v-model="activeTab" @tab-change="handleTabChange" type="border-card">
				<!-- Prompts management -->
				<el-tab-pane label="Prompts Management" name="prompts">
					<RolePromptsDetail
						:prompts="prompts"
				...
				<el-tab-pane label="Relationship Levels" name="relationships">
					<RoleRelationshipsDetail
						:relationshipLevels="relationshipLevels"
						:loading="relationshipLevelsLoading"
						:roleId="roleId"
						@refresh="fetchRelationshipLevels"
					/>
				</el-tab-pane>

				<!-- Knowledge base management -->
				<el-tab-pane label="Knowledge Base Management" name="knowledge">
					<RoleKnowledgeDetail
						:knowledgeList="knowledgeList"
						:knowledgeJoinList="knowledgeJoinList"
