...
<template>
	<span :class="props.customClass" @click="drawer = true">
		...
		<el-drawer v-model="drawer" :with-header="false" size="280">
			<div class="setting">
				<el-divider>Theme Mode</el-divider>
				<div class="theme-box">
					<el-tooltip content="Light" placement="top">
					...
					<el-tooltip content="Dark" placement="top">
				...
				<el-divider>Navigation Layout</el-divider>
				<div class="nav-box">
					<el-tooltip content="Vertical" placement="top">
						<div
					...
					<el-tooltip content="Horizontal" placement="top">
						<div
				...
				<el-divider>Navigation Style</el-divider>
				<div class="nav-box">
