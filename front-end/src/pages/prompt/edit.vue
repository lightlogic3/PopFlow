		...
		<div class="form-container">
			<div class="form-section">
				<el-form ref="formRef" :model="form" :rules="rules" label-width="100px" label-position="top">
					<FormItem label="Template Function" prop="role" tooltipKey="role">
						<el-select v-model="form.type" placeholder="Please select template function" :disabled="!!route.params.id">
					...
					<FormItem label="Template ID" prop="role_id" tooltipKey="role_id">
						<el-input
							...
							placeholder="Please enter template ID (English) with underscores between words"
						/>
					</FormItem>
		...
		if (valid) {
			try {
				if (isEdit.value) {
					...
					ElMessage.success("Addition successful");
				}
				handleBack();
			} catch (error) {
