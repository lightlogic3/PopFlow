<!-- KnowledgeList.vue - Knowledge Repository Fragment List Component -->
...
// Computed property: whether to display pagination component (only shown when data exceeds 10 items)
...
const deleteKnowledge = (knowledge: WorldKnowledge) => {
	ElMessageBox.confirm("Are you sure you want to delete this knowledge fragment?", "Confirm", {
...
/**
 * Select knowledge and show related roles
 * @param {WorldKnowledge} knowledge - Knowledge item
 */
	...
	<el-card class="section-card">
		<template #header>
			<div class="section-header">
				...
				<el-button class="btn-fix" type="primary" size="small" @click="addNewKnowledge">
		...
		<div class="knowledge-list" v-loading="knowledgeLoading">
			<el-empty v-if="knowledgeList.length === 0" description="No knowledge fragments" />
					...
					<template #footer>
						<div class="knowledge-card-footer">
							...
							<div class="knowledge-actions">
								<el-button class="btn-fix" type="primary" link @click.stop="editKnowledge(knowledge)">
									<el-icon>
											<Edit />
										</el-icon>
										Try out
		...
		<!-- Pagination component (only shown when data exceeds 10 items) -->
