<!-- WorldInfo.vue - Component to display world view basic information -->
...
/**
 * Return to the world view list page
 */
const goBack = () => {
...
<template>
	<div>
		<div class="header">
			...
			<h1 class="title">World View Details</h1>
		</div>
				...
				<div class="world-details">
					...
					<div class="world-stats">
						<div class="stat-item">
							...
							<span>Knowledge items: {{ world.knowledge_count }}</span>
						</div>
					</div>
