...
class Kimi(BaseLLM):
    """Kimi AI API implementation class"""
    
    # Set the LLM type identifier
    llm_type = "kimi"
    

    def __init__(self, api_key: str, model: str = "kimi-v2", base_url: str = None, format_response: bool = True):
        """Initialize Kimi AI client side

Args:
api_key: API Key
Model: model name, defaults to'kimi-v2'
